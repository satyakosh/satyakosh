...
| Check | Result | Detail |
|---|---|---|
| seal | PASS | 9000 facts + genesis in 2.0s (4412 seals/s) |
| verify clean chain | PASS | 0 findings expected, got 0 in 0.6s |
| verify(full) seal-time replay | PASS | 0 findings expected, got 0 in 2.7s |
